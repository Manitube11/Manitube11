...
class TradingApp:
    ...
    def _build_settings_tab(self):
        frame = ttk.LabelFrame(self.tab_settings, text="Telegram Configuration", padding=20)
    ...
    def _build_dashboard_tab(self):
        ...
        self.tree = ttk.Treeview(self.tab_dashboard, columns=columns, show="headings", height=12)
        ...
        # Populate with all assets
        self.watched_assets = list(self.feed.assets.keys())
    ...
    def save_settings(self):
        ...
        try:
            ...
            self.log("Configuration Saved to disk.")
