...
class TradingApp(ctk.CTk):
            ...
            if signal['Type'] in ['BUY', 'SELL']:
                    ...
                    if signal['Type'] != last_sig:
                        ...
                        if self.bot_manager:
                            ...
                            self.bot_manager.broadcast_signal(signal, image_path=chart_path)
    ...
    def save_settings(self):
        ...
        self.bot_manager = BotManager(t, c)
        self.bot_manager.start()
        self.log("Settings Saved & Bot Started (Listening for commands).")
        ...
        if os.path.exists(self.config_file):
            try:
                with open(self.config_file) as f:
                    ...
                    if cfg.get("token"):
                        self.bot_manager = BotManager(cfg["token"], cfg["chat_id"])
                        self.bot_manager.start()
                        self.log("Bot Connected & Listening...")
    ...
    def force_test_signal(self):
        ...
        self.bot_manager.broadcast_signal(dummy)
